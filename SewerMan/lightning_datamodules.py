...
class MultiLabelDataModule(pl.LightningDataModule):
    ...
    def __init__(self, batch_size=32, workers=12, ann_root="./annotations", data_root="./Data", only_defects=False, train_transform = None, eval_transform = None):
        super().__init__()
...
class BinaryRelevanceDataModule(pl.LightningDataModule):
    ...
    def __init__(self, batch_size=32, workers=4, ann_root="./annotations", data_root="./Data", defect=None, train_transform = None, eval_transform = None):
        super().__init__()
        self.batch_size = batch_size
        self.workers = workers
        self.ann_root = ann_root
